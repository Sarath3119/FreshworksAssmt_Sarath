...
<h1>Freshworks – Backend Assignment</h1>
...
Submissions:
The functionality and implemetation of CRD operations are in core.ipnyb file.
The CRD operations are analysed and tested in CRD-exec.ipynb file
